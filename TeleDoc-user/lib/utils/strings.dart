class Strings {
  ...
  static String demoName = 'Jesika Sabrina';
  ...
  static String demoSsn = '12345678912345';
  ...
  //search doctor details
  static String setAppointment = 'Set Appointment';
  ...
  static String nb = 'NB';
  static String ifYouHavePreviousMedicalHistoryFile =
      'If you have medical history file';
  ...
  static String callNow = 'Call Now';
  static String icuSupport = 'ICU Support';
  ...
  // set pill reminder screen
  static String nameOfPill = 'Name Of Pill';
  static String selectDay = 'Select Day';
  ...
  static String giveYourRating = 'Give Your Rating';
  static String behaviour = 'Behaviour';
  static String service = 'Service';
  static String cost = 'Cost';
  static String skill = 'Skill';
  static String yourComment = 'Your Comment';
  static String contraryToPopular =
      'Contrary to popular belief, Lorem Ipsum is notsimply random '
      'text. ';
  static String contactYourDoctor = 'Contact Your Doctor';
  static String submitReview = 'Submit Review';

  // message screen
  static String chatWithDoctor = 'Chat With Doctor';
